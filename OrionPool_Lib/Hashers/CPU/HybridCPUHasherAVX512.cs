...
{
    public unsafe class HybridCPUHasherAVX512 : BaseCPUHasher
    {
        public override string Name => "Hybrid AVX512";
        public override string Description => "C#/C Drillx implementation with minor AVX512 optimizations";
