...
namespace DrillX.Compiler
{
    public unsafe class AVX512Compiler
    {
        ...
        { 
            ...
            // Load vectors from memory into zmm0-zmm7 (each increment is 8*8=64 bytes for ulong*)
        ...
        public readonly static byte[] avx512Prologue_Linux = new byte[]
        {
            ...
            // Load vectors (now rcx contains the pointer)
            0x62, 0xF1, 0xFE, 0x48, 0x6F, 0x01,         // vmovdqu64 zmm8, [rcx]
            0x62, 0xF1, 0xFE, 0x48, 0x6F, 0x49, 0x40,   // vmovdqu64 zmm9, [rcx+64]
            0x62, 0xF1, 0xFE, 0x48, 0x6F, 0x51, 0x80,   // vmovdqu64 zmm10, [rcx+128]
            0x62, 0xF1, 0xFE, 0x48, 0x6F, 0x59, 0xC0,   // vmovdqu64 zmm11, [rcx+192]
            0x62, 0xF1, 0xFE, 0x48, 0x6F, 0x61, 0x00,   // vmovdqu64 zmm12, [rcx+256]
            0x62, 0xF1, 0xFE, 0x48, 0x6F, 0x69, 0x40,   // vmovdqu64 zmm13, [rcx+320]
            0x62, 0xF1, 0xFE, 0x48, 0x6F, 0x71, 0x80,   // vmovdqu64 zmm14, [rcx+384]
            0x62, 0xF1, 0xFE, 0x48, 0x6F, 0x79, 0xC0    // vmovdqu64 zmm15, [rcx+448]
        };
        ...
        public readonly static byte[] avx512Epilogue_Linux = new byte[]
        {
            ...
            0x62, 0xF1, 0xFE, 0x48, 0x7F, 0x49, 0x40,   // vmovdqu64 [rcx+64], zmm9
            0x62, 0xF1, 0xFE, 0x48, 0x7F, 0x51, 0x80,   // vmovdqu64 [rcx+128], zmm10
            0x62, 0xF1, 0xFE, 0x48, 0x7F, 0x59, 0xC0,   // vmovdqu64 [rcx+192], zmm11
            0x62, 0xF1, 0xFE, 0x48, 0x7F, 0x61, 0x00,   // vmovdqu64 [rcx+256], zmm12
            0x62, 0xF1, 0xFE, 0x48, 0x7F, 0x69, 0x40,   // vmovdqu64 [rcx+320], zmm13
            0x62, 0xF1, 0xFE, 0x48, 0x7F, 0x71, 0x80,   // vmovdqu64 [rcx+384], zmm14
            0x62, 0xF1, 0xFE, 0x48, 0x7F, 0x79, 0xC0,   // vmovdqu64 [rcx+448], zmm15
